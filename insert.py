insert_into = """'Alberto Vieira','25.507.105-2','168.637.122-53','1997-07-01','2020-09-28',
...
lista = insert_into.split('\n')
dict_1 = {}
for i , pessoa in enumerate(lista):
    
    item = pessoa.split(',')
    dict_1[i] = {"id_pessoa":i,"nome":item[0],"rg":item[1],"cpf":item[2],"data_nascimento":item[3],"data_admissao":item[4],"funcao":item[5]}
